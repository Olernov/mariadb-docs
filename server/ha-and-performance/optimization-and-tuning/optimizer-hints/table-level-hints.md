...
```
See [Syntax of query-block](expanded-optimizer-hints.md#syntax-of-query-block-level-hints) and [table level hints](expanded-optimizer-hints.md#syntax-table-level-hints) for more information.
